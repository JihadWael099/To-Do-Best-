...
public class ToDoDetails {
    ...
    public ToDoDetails(int id, String description, Priority priority, LocalDateTime createAt,
                       LocalDateTime startAt, LocalDateTime finishAt, Status status,
                       TodoEntity todoEntity, int entityId) {
        this.id = id;
